...
const STEPS: readonly TimelineStepData[] = [
  {
    ...
    imageSrc: '/source_how_it_works.jpeg',
  },
  {
    step: 2,
    title: 'Preparation',
    ...
    imageSrc: '/prep_how_it_works.jpg',
  },
  {
    step: 3,
    ...
    imageSrc: '/shipping_how_it_works.jpg',
  },
  {
    step: 4,
    title: 'UK Arrival & Road Registration',
    body: 'Vehicles arrive in the UK, clear customs, and are fully prepared for the road, including DVLA registration and UK number plate installation.',
    imagePlaceholder: 'UK arrival and road registration',
    imageSrc: '/arrival_how_it_works.jpg',
  },
  {
    step: 5,
    title: 'Delivery and Handover',
    body: `Your vehicle is delivered directly to you by ${BRAND_SHORT}, fully registered, road-ready, and ready to sell.`,
    imagePlaceholder: 'UK registration and delivery',
    imageSrc: '/delivery_how_it_works.jpg',
  },
];
